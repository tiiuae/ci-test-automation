...
Check that unauthorised user has no access to host devices
    ...
    ${sda_access}       Check access   /dev/sda
    Run Keyword And Continue On Failure 	Should Not Be True  ${nvme0n1_access}
    Run Keyword And Continue On Failure 	Should Not Be True  ${sda_access}
...
Check access to host devices in ${vm}
    ...
    IF    '${vm}' == 'ghaf-host'
        ...
        Run Keyword And Continue On Failure 	Should Be True  ${sda_access}
    ELSE
        Run Keyword And Continue On Failure 	Should Not Be True  ${nvme0n1_access}
        Run Keyword And Continue On Failure 	Should Not Be True  ${sda_access}
    END
