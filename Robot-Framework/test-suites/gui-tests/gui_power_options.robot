...
GUI Suspend and wake up
    ...
    [Teardown]    Run Keyword If Test Failed    Skip    "Known issue: Suspend from power menu does not work"
...
GUI Reboot
    ...
    [Setup]           Skip    "Known issue: Reboot from power menu does not work (system will get stuck)"
