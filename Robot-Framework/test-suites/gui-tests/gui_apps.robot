...
Start and close Google Chrome via GUI on LenovoX1
    ...
    [Teardown]        Run Keyword If Test Failed     Skip    "Known issue: Chrome does not have top bar"
...
Start and close Sticky Notes via GUI on LenovoX1
    ...
    Start app via GUI on LenovoX1   ${GUI_VM}  sticky-wrapped   Sticky
    Close app via GUI on LenovoX1   ${GUI_VM}  sticky-wrapped  ./window-close.png
    [Teardown]        Run Keyword If Test Failed     Skip    "Known issue: Sticky Notes does not launch from icon"
...
Start and close COSMIC Files via GUI on LenovoX1
    ...
    Start app via GUI on LenovoX1   ${GUI_VM}  cosmic-files  Files  exact_match=true
...
Start and close Falcon AI via GUI on LenovoX1
    ...
    Close app via GUI on LenovoX1   ${GUI_VM}  alpaca-wrapped  ./window-close-neg.png  iterations=10
