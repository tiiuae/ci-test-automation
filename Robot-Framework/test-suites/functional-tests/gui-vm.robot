...
Force Tags          gui-vm-apps   lenovo-x1   dell-7330
...
Start Calculator on LenovoX1
    ...
    [Tags]            bat   regression   calculator  SP-T202
...
Start Sticky Notes on LenovoX1
    ...
    [Tags]            bat   regression   sticky_notes  SP-T201-1
...
Start Ghaf Control Panel on LenovoX1
    ...
    [Tags]            bat   regression   control_panel  SP-T205
...
Start Bluetooth Settings on LenovoX1
    ...
    [Tags]            bat   regression   bluetooth_settings  SP-T204
...
Start COSMIC Files on LenovoX1
    ...
    [Tags]            bat   regression   cosmic_files  SP-T206
    IF  $COMPOSITOR == 'cosmic'
...
Start COSMIC Settings on LenovoX1
    ...
    [Tags]            bat   regression   cosmic_settings  SP-T254
    IF  $COMPOSITOR == 'cosmic'
...
Start COSMIC Text Editor on LenovoX1
    ...
    [Tags]            bat   regression   cosmic_editor  SP-T243
    IF  $COMPOSITOR == 'cosmic'
...
Start Falcon AI on LenovoX1
    ...
    [Tags]            regression   falcon_ai  SP-T223-1
    IF  $COMPOSITOR == 'cosmic'
        Get Falcon LLM Name
